...
export const IconDiscord: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M9 12h6m-6 4h6m2 5a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2 2z" style={{ display: 'none' }} /> {/* Placeholder, real path below */}
        <path d="M18.8943 4.34399C17.5132 3.70899 16.0354 3.24499 14.4849 3.01699C14.4608 3.01399 14.4367 3.02999 14.4255 3.05199C14.2384 3.38599 14.0321 3.82999 13.8878 4.17299C12.2575 3.92899 10.6354 3.92899 9.03434 4.17299C8.89101 3.82999 8.68377 3.38499 8.4957 3.05199C8.48446 3.02999 8.45934 3.01399 8.43522 3.01699C6.88476 3.24499 5.40597 3.70899 4.02591 4.34399C4.01385 4.34999 4.0048 4.35999 3.99981 4.37199C1.19231 8.52599 0.42851 12.61 0.80352 16.634C0.80552 16.657 0.81952 16.678 0.83852 16.691C2.69343 18.065 4.49204 18.898 6.25793 19.444C6.28092 19.451 6.30592 19.441 6.32092 19.421L7.54573 17.989C7.56272 17.969 7.55872 17.939 7.53573 17.925C7.00984 17.725 6.50596 17.488 6.02308 17.218C5.98609 17.197 5.98309 17.143 6.01508 17.118C6.11306 17.045 6.20904 16.969 6.30302 16.891C6.31902 16.877 6.34101 16.874 6.36001 16.882C9.57041 18.354 12.986 18.354 16.1683 16.882C16.1873 16.873 16.2103 16.877 16.2253 16.891C16.3203 16.969 16.4162 17.045 16.5132 17.118C16.5452 17.143 16.5432 17.197 16.5062 17.218C16.0223 17.487 15.5174 17.724 14.9915 17.924C14.9685 17.939 14.9645 17.969 14.9815 17.989L16.2063 19.421C16.2213 19.441 16.2463 19.451 16.2693 19.444C18.0362 18.898 19.8348 18.065 21.6897 16.691C21.7087 16.678 21.7227 16.657 21.7247 16.634C22.1856 11.916 20.9758 7.86899 18.9194 4.37199C18.9144 4.35999 18.9054 4.34999 18.8943 4.34399ZM8.08375 14.659C7.10887 14.659 6.30802 13.759 6.30802 12.649C6.30802 11.539 7.08888 10.639 8.08375 10.639C9.08862 10.639 9.88947 11.549 9.86948 12.649C9.86948 13.759 9.07863 14.659 8.08375 14.659ZM14.4549 14.659C13.479 14.659 12.6782 13.759 12.6782 12.649C12.6782 11.539 13.459 10.639 14.4549 10.639C15.4598 10.639 16.2606 11.549 16.2406 12.649C16.2406 13.759 15.4598 14.659 14.4549 14.659Z" fill={color} stroke="none" />
    </svg>
);

export const IconXLogo: React.FC<IconProps> = ({ size = 24, color = 'currentColor', className }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round" className={className}>
