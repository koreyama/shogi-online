export const RELEASES = [
    {
        version: '2.8.0',
        date: '2026.01.29',
        title: 'マルバツゲーム リリース & 機能追加',
        categories: ['New Game', 'Update'],
        content: [
            {
                head: 'マルバツゲーム (Tic-Tac-Toe) リリース',
                text: 'シンプルながら奥深い「マルバツゲーム」が登場！3つ目までは通常通り、4つ目を置くと一番古いコマが消える「無限」ルールを採用し、終わりのない攻防を楽しめます。'
            },
            {
                head: 'マルチプレイ & チャット機能',
                text: '世界中のプレイヤーとランダムマッチ、または友達とルームIDで対戦が可能。対戦中はリアルタイムチャットでコミュニケーションが取れます。'
            },
            {
                head: 'AI対戦モード',
                text: '練習用にAI対戦モードも搭載。空き時間にサクッと遊べます。'
            }
        ]
    },
    {
        version: '2.7.0',
        date: '2026.01.28',
        title: '絵しりとり リリース & UI改善',
        categories: ['New Game', 'Drawing'],
        content: [
            {
                head: '新作「絵しりとり」リリース',
                text: '絵を描いて言葉を繋げる「絵しりとり」が登場！前の人の絵を予想して答えを入力し、次の人に新しい絵のバトンを渡しましょう。'
            },
            {
                head: '高機能キャンバス & マルチプレイ',
                text: 'リアルタイムで同期される軽量キャンバスを搭載。ペン、消しゴム、ズームなどの基本機能に加え、レイヤー構造を排除したシンプルなUIでお絵かきに集中できます。友達とのルーム対戦にも対応。'
            },
            {
                head: 'モバイル最適化',
                text: 'スマートフォンでも快適に遊べるよう、入力フォームや描画ツールを最適化しました。外出先でも手軽に絵しりとりを楽しめます。'
            }
        ]
    },
    {
