    ...
    if (!targetUserId && mounted) {
        return (
            <div className={styles.container}>
                ...
                <Link href="/" className={styles.backLink}>トップに戻る</Link>
            </div>
        );
    }
                                ...
                                {incomingRequests.map(f => (
                                    <div key={f.uid} className={styles.friendCard} style={{ cursor: 'default' }}>
                                        ...
                                        <div className={styles.friendInfo}>
                                            <Link href={`/profile?id=${f.uid}`} className={styles.friendName} style={{ textDecoration: 'underline' }}>
                    ...
                    <div className={styles.friendGrid}>
                        {friends.map(f => (
                            <div key={f.uid} className={styles.friendCard}>
                                <Link href={`/profile?id=${f.uid}`} className={styles.friendLinkContent}>
                                    <div className={styles.friendAvatarPlaceholder}>
                                        {f.photoURL ? (
                                            <img src={f.photoURL} alt={f.displayName} className={styles.friendAvatarImg} />
                                        ) : (
