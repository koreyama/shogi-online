    ...
    return (
        <main className={styles.main}>
            ...
            <div className={styles.gameContainer}>
                <h1 className={styles.title}>チェッカー</h1>
                <p className={styles.subtitle}>斜めに動き、相手を飛び越えて捕獲する伝統ゲーム</p>
                    ...
                    <div className={styles.joinSection}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', width: '100%', maxWidth: '340px' }}>
                            <div style={{ textAlign: 'center' }}>
                                ...
                                <button onClick={handleRoomCreate} className={styles.primaryBtn} style={{ width: '100%', background: 'linear-gradient(135deg, #9f7aea 0%, #805ad5 100%)', color: '#fff' }}>
                                    ルーム作成（ID自動発行）
                                </button>
                            </div>
                ...
                <div className={styles.contentSection}>
                    ...
                    <div className={styles.sectionBlock}>
                        ...
                        <div className={styles.cardGrid}>
                            ...
                            <div className={styles.infoCard}>
                                <span className={styles.cardTitle}>2. ジャンプ</span>
                                <p className={styles.cardText}>隣に相手の駒があり、その奥が空いている場合、飛び越えて相手の駒を取ることができます。</p>
                            </div>
                            <div className={styles.infoCard}>
                                <span className={styles.cardTitle}>3. 強制ジャンプ</span>
                                <p className={styles.cardText}>取れる駒がある場合は、必ず取らなければなりません。複数取れる場合は更に取り続けます。</p>
                            </div>
                            <div className={styles.infoCard}>
                                <span className={styles.cardTitle}>4. キング</span>
