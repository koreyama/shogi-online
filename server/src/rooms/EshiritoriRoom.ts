...
const SHIRITORI_WORDS = [
    // 動物
    "いぬ", "ねこ", "うさぎ", "くま", "さる", "きつね", "たぬき", "しか", "ぞう",
    "かば", "わに", "へび", "かえる", "かめ", "あひる", "にわとり", "すずめ", "からす", "つばめ",
    "くじら", "いるか", "さめ", "たこ", "いか", "えび", "かに", "くらげ", "ひとで", "かい",
    "とら", "こあら", "ぱんだ", "うま", "ひつじ", "やぎ", "いのしし", "りす",
    // 食べ物
    "りんご", "ばなな", "いちご", "すいか", "もも", "ぶどう", "なし", "かき",
    "おにぎり", "すし", "そば", "ぱすた", "ぴざ", "かれー", "はんばーぐ",
    "けーき", "あいす", "ちょこ", "くっきー", "どーなつ",
    "とまと", "きゅうり", "なす", "たまご", "えびふらい", "おむらいす", "たこやき", "やきそば", "すてーき",
    // 乗り物
    "くるま", "ばす", "でんしゃ", "ひこうき", "ふね", "じてんしゃ", "ばいく", "たくしー", "へりこぷたー",
    "とらっく", "ぱとかー", "きゅうきゅうしゃ", "しょうぼうしゃ", "よっと", "ろけっと",
    // 自然
    "やま", "かわ", "うみ", "そら", "ほし", "つき", "たいよう", "くも", "あめ", "ゆき", "かぜ", "にじ",
    "はな", "き", "くさ", "はっぱ", "もり", "しま", "いわ", "すな",
    "いけ", "たき", "さばく", "かみなり",
    // 物・衣類
    "いす", "つくえ", "えんぴつ", "けしごむ", "はさみ", "のり", "かさ", "くつ",
    "ぼうし", "めがね", "とけい", "てれび", "らじお", "かめら", "でんわ",
    "べっど", "そふぁ", "れいぞうこ", "せんぷうき", "すまほ", "のーと", "ふでばこ",
    "てぶくろ", "くつした", "まふらー", "しゃつ",
    // スポーツ
    "やきゅう", "さっかー", "てにす", "すきー",
    // その他
